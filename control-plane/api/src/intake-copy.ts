...
export const UI_STRINGS: Record<Language, Record<string, string>> = {
  en: {
    ...
    "change.uneditable": "I can't change {what} by typing — what is saved isn't in a form I can edit. Nothing was changed. Please tell the Kinerary team, who can fix it.",
    "change.sendFailed": "I couldn't show you that change just now. Please send it again in a moment.",
  ...
  he: {
    ...
    "change.uneditable": "אי אפשר לשנות את {what} בהקלדה — מה ששמור אינו במבנה שאפשר לערוך. לא שיניתי כלום. ספרו לצוות של Kinerary, הם יוכלו לתקן.",
    "change.sendFailed": "לא הצלחתי להראות לכם את השינוי עכשיו. שלחו אותו שוב בעוד רגע.",
