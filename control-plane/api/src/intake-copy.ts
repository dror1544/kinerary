...
export const UI_STRINGS: Record<Language, Record<string, string>> = {
  en: {
    ...
    "change.footer": "Tap a button, or just reply yes or no.",
    "change.apply": "Yes, apply",
    "change.cancel": "No, cancel",
    ...
    "change.warn.bookingInRemovedStop.unknown": "⚠️ {booking} falls inside {stop} and stays on record. I don't know its cancellation terms — check before removing.",
    "change.warn.bookingInRemovedStop.non_refundable": "⚠️ {booking} falls inside {stop} and is marked non-refundable / cannot be cancelled. It stays on record — check before removing.",
    "change.warn.bookingForRemovedTraveller.unknown": "⚠️ {booking} is in {traveller}'s name. I don't know its cancellation terms — check before removing.",
    "change.warn.bookingForRemovedTraveller.non_refundable": "⚠️ {booking} is in {traveller}'s name and is marked non-refundable / cannot be cancelled — check before removing.",
    "change.warn.bookingInRemovedStop.more": "⚠️ …and {count} more confirmed bookings fall inside {stop} and stay on record. I don't know their cancellation terms — check them before removing.",
    "change.warn.bookingInRemovedStop.moreNonRefundable": "⚠️ …and {count} more confirmed bookings fall inside {stop} and stay on record — {nonRefundable} of them marked non-refundable / cannot be cancelled. Check them before removing.",
    "change.warn.bookingForRemovedTraveller.more": "⚠️ …and {count} more confirmed bookings are in {traveller}'s name. I don't know their cancellation terms — check them before removing.",
    "change.warn.bookingForRemovedTraveller.moreNonRefundable": "⚠️ …and {count} more confirmed bookings are in {traveller}'s name — {nonRefundable} of them marked non-refundable / cannot be cancelled. Check them before removing.",
    ...
    "change.sendFailed": "I couldn't show you that change just now, so it's waiting. Reply \"yes\" or \"no\" and I'll show it to you again.",
  ...
  he: {
    ...
    "change.warn.daysDropped": "⚠️ ימים שיימחקו מ{entry}: {dates}",
    ...
    "change.warn.bookingInRemovedStop.unknown": "⚠️ ההזמנה {booking} נופלת בתוך {stop} ונשארת ברשומה. אני לא יודע מה תנאי הביטול שלה — כדאי לבדוק לפני שמסירים.",
    "change.warn.bookingInRemovedStop.non_refundable": "⚠️ ההזמנה {booking} נופלת בתוך {stop} ומסומנת כבלתי ניתנת להחזר / לביטול. היא נשארת ברשומה — כדאי לבדוק לפני שמסירים.",
    "change.warn.bookingForRemovedTraveller.unknown": "⚠️ ההזמנה {booking} על שם {traveller}. אני לא יודע מה תנאי הביטול שלה — כדאי לבדוק לפני שמסירים.",
    "change.warn.bookingForRemovedTraveller.non_refundable": "⚠️ ההזמנה {booking} על שם {traveller} ומסומנת כבלתי ניתנת להחזר / לביטול — כדאי לבדוק לפני שמסירים.",
    "change.warn.bookingInRemovedStop.more": "⚠️ ועוד {count} הזמנות מאושרות נופלות בתוך {stop} ונשארות ברשומה. אני לא יודע מה תנאי הביטול שלהן — כדאי לבדוק אותן לפני שמסירים.",
    "change.warn.bookingInRemovedStop.moreNonRefundable": "⚠️ ועוד {count} הזמנות מאושרות נופלות בתוך {stop} ונשארות ברשומה — מתוכן, מסומנות כבלתי ניתנות להחזר / לביטול: {nonRefundable}. כדאי לבדוק אותן לפני שמסירים.",
    "change.warn.bookingForRemovedTraveller.more": "⚠️ ועוד {count} הזמנות מאושרות על שם {traveller}. אני לא יודע מה תנאי הביטול שלהן — כדאי לבדוק אותן לפני שמסירים.",
    "change.warn.bookingForRemovedTraveller.moreNonRefundable": "⚠️ ועוד {count} הזמנות מאושרות על שם {traveller} — מתוכן, מסומנות כבלתי ניתנות להחזר / לביטול: {nonRefundable}. כדאי לבדוק אותן לפני שמסירים.",
    "change.warn.removesEverything.phases": "⚠️ זה ימחק את כל העצירות — את כל מסלול הטיול.",
    "change.warn.removesEverything.travelers": "⚠️ זה ימחק את כל הנוסעים — את כל הרשימה.",
    "change.warn.bookingsWhoseNameUnknown": "⚠️ יש {count} הזמנות מאושרות (טיסות או כרטיסים) ואני לא יכול לדעת על שם מי הן. כדאי לבדוק אותן לפני שמסירים מישהו.",
    "change.effect.organizerIdentityReopens": "אז אצטרך לשאול שוב מי מהנוסעים הוא אתם.",
    ...
    "change.blocked.possibleDuplicate": "האם {name} הוא מישהו שכבר ברשימה ({candidates}) או נוסע חדש? אם זה אותו אדם, כתבו מה לשנות; אם זה מישהו חדש, כתבו את שמו המלא.",
    "change.blocked.generic": "לא הצלחתי להבין את השינוי הזה. אפשר לנסח שוב במשפט אחד?",
    "change.ask.which": "למי או למה התכוונתם ב\"{name}\"?",
    "change.ask.whichNone": "לא מצאתי את \"{name}\" בין {noun}. למי התכוונתם? אפשר ללחוץ על אחד, או לכתוב לי.",
    ...
    "change.stillBlocked": "אי אפשר לבצע את השינוי עדיין — ענו על השאלה למעלה, או בטלו אותו.",
    ...
    "change.tooBig": "זה הרבה בבת אחת — אשרו או בטלו את מה שממתין קודם, ואז שלחו את השאר.",
    ...
    "change.sendFailed": "לא הצלחתי להראות לכם את השינוי עכשיו, אז הוא ממתין. ענו \"כן\" או \"לא\" ואציג אותו שוב.",
