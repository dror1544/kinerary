...
export const UI_STRINGS: Record<Language, Record<string, string>> = {
  en: {
    ...
    "change.uneditable": "I can't change {what} by typing — it was saved in a form I can't edit, so nothing was changed. You can carry on with the next question, or tell me in one message what you'd like.",
  ...
  he: {
    ...
    "change.uneditable": "אי אפשר לשנות את {what} בהקלדה — זה נשמר בצורה שאני לא יכול לערוך, ולכן לא שיניתי כלום. אפשר להמשיך לשאלה הבאה, או לכתוב לי במשפט אחד מה תרצו.",
