...
async function main(): Promise<void> {
  ...
  if (runtime.db) {
    stopPolling = startTripBotPoller({
      ...
      ...(runtime.superAdminSubjectDigest ? { superAdminSubjectDigest: runtime.superAdminSubjectDigest } : {}),
      media: { telegram: runtime.telegram, store: mediaStore, baseUrl: mediaBaseUrl, log },
      // Undefined unless a runner is configured. A session flagged onto the
