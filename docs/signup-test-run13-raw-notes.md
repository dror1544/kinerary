...
| 2 — "Redirected current run" reached the organizer | Step 3 #16 | Fixed |
| 3, 4 — the eleven-minute stall | Step 3 #17 | Fixed |
| 5 — router-owned questions competing | Step 3 #18 | Fixed |
