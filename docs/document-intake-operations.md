...
| Migration | Adds |
|---|---|
| `0052_document_registry.sql` | `trip_documents`; `source_artifacts.document_id/filename/received_at`; `trip_document_extractions` |
| `0053_answer_provenance.sql` | `trip_answer_sources`, `trip_answer_conflicts` |
| `0054_model_task_settings.sql` | `model_task_settings`, append-only `model_task_setting_history` |
| `0055_document_corrections.sql` | `trip_document_corrections` (post-confirm proposals) |
